...
Vue.component("search", {
  data: function() {
    return {
      message: "",
      results: [],
      root: "https://eul.ink/complex-analysis/"
    };
  },
  template: "<div> \n  <div>\n    <i \n      class=\"fa fa-search\" aria-hidden=\"true\" \n      style=\"marginRight:0.5em;\">\n    </i>\n    <input \n      type=\"text\" v-model=\"message\" placeholder=\"Search\"\n      style=\"width:auto;\">\n  </div>\n  <ul>\n    <li v-for=\"result in results\">\n      <a target=\"_blank\" \n         :href=\"url(result)\">\n         {{result.title}}\n      </a> ({{result.score}})\n    </li>\n  </ul>\n</div>",
  methods: {
    url: function(result) {
      return this.root + result.title;
    }
  },
  watch: {
    message: function(message) {
      var i, len, raw_results, result, results, score, title;
      raw_results = lunrIndex.search(message + "*");
      results = [];
      for (i = 0, len = raw_results.length; i < len; i++) {
